            ...
            {result && createPortal(
                <div style={{
                    ...
                    <div style={{ 
                        ...
                        color: 'var(--ws-black)',
                        boxShadow: 'inset 0 0 0 2px var(--ws-black), 0 8px 24px rgba(0,0,0,0.2)'
                    }}>
                        <div style={{
                            fontSize: '0.7rem',
                        ...
                        <div style={{ fontSize: '18px', lineHeight: '1.6', marginBottom: '24px', textAlign: 'left' }}>
                            <strong>Pipeline Analyzed!</strong><br/><br/>
                        ...
                        <button 
                            ...
                            style={{ 
                                ...
                                border: '2px solid var(--ws-black)', padding: '6px 16px', 
                                cursor: 'pointer', fontFamily: 'inherit', fontSize: '16px',
                                alignSelf: 'flex-end', borderRadius: 'var(--radius)',
                                transition: 'all 0.2s'
                            }}
                            onMouseOver={(e) => { e.target.style.background = 'var(--ws-white)'; e.target.style.color = 'var(--ws-black)'; }}
                            onMouseOut={(e) => { e.target.style.background = 'var(--ws-black)'; e.target.style.color = 'var(--ws-white)'; }}
                        >
                            CLOSE
                        </button>
                    </div>
