...
export const TextNode = ({ id, data, selected }) => {
  ...
  const variables = [...new Set([...currText.matchAll(/{{\s*([a-zA-Z_$][a-zA-Z_$0-9]*)\s*}}/g)].map(m => m[1]))];

  return (
    <BaseNode id={id} type="text" title="Text" data={data} selected={selected} style={{ width: dimensions.width }}>
